...
Shader "Asteroids/AsteroidShader"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEEnd]_RandomPerInstanceVector("_RandomPerInstanceVector", Vector) = (1,1,1,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 _RandomPerInstanceVector;
						...
						)
			{
				...
				Gradient gradient30 = NewGradient( 0, 5, 4, float4( 0.05, 0.05, 0.05, 0 ), float4( 0.546, 0.5227659, 0.5227659, 0.3117723 ), float4( 0.216, 0.2005714, 0.2005714, 0.520592 ), float4( 0.2830189, 0.1828943, 0.1828943, 0.7588311 ), float4( 0.19, 0.1240278, 0.1240278, 0.9676509 ), 0, 0, 0, float2( 1, 0 ), float2( 1, 0.6294194 ), float2( 1, 0.7000076 ), float2( 1, 0.8588235 ), 0, 0, 0, 0 );
				...
				float simplePerlin2D32 = snoise( temp_output_29_0.xy*200.0 );
				...
				surfaceDescription.Albedo = SampleGradient( gradient30, simplePerlin3D13 ).rgb;
				surfaceDescription.Normal = worldToTangentDir42_g2;
				...
				surfaceDescription.Smoothness = 0.2;
...
/*ASEBEGIN
Version=18912
2084;7;1543;1045;1184.747;830.6719;1.3;True;False
Node;AmplifyShaderEditor.Vector3Node;24;-685.9356,270.475;Inherit;False;Property;_RandomPerInstanceVector;_RandomPerInstanceVector;0;0;Create;True;0;0;0;False;0;False;1,1,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleAddOpNode;26;-375.9356,67.47501;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ObjectScaleNode;28;-551.5359,-468.325;Inherit;False;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;-296.9356,-143.525;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-332.5,222.5;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;0.001;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-297.0828,364.0306;Inherit;False;Constant;_Float1;Float 1;1;0;Create;True;0;0;0;False;0;False;200;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GradientNode;30;-109.9356,-262.525;Inherit;False;0;5;4;0.05,0.05,0.05,0;0.546,0.5227659,0.5227659,0.3117723;0.216,0.2005714,0.2005714,0.520592;0.2830189,0.1828943,0.1828943,0.7588311;0.19,0.1240278,0.1240278,0.9676509;1,0;1,0.6294194;1,0.7000076;1,0.8588235;0;1;OBJECT;0
